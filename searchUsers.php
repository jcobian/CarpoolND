...
$q = 'select firstname, lastname, username, email, phonenumber from users';
...
//We want to loop through all of the rows from the result of the query
          print '<tr>';
  print '<td><b>First Name </b></td> <td><b>Last Name</b></td> <td><b>Username</b></td> <td><b>Email</b></td> <td><b>Phone Number</b></td>';
print '<tr>';
