...
$q = "select startingpoint, destination, startdate, starttime, eta, description, openseats, driver from carpool where destination = 'Pittsburgh'";
//Parse that SQL query into a statement
$s = oci_parse($c, $q);
//oci_bind_by_name($s, ":z", $destination);
