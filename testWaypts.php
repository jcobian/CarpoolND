...
//var myData = <?php echo json_encode($originsLatArray);?>;
//alert(JSON(myData[0]))
...
function calcRoute(startLat, startLng, endLat, endLng) {
  ...
  waypts.push({
	location: passengerStart,//"chicago, il",//document.getElementByIt('start').value;
	stopover: true
  });
  waypts.push({
...
<div class="form-group"><label for="start">Starting Point: <input name="start" id="start" type="textbox" onchange="findTimes(); codeAddress(this);"/></div>
